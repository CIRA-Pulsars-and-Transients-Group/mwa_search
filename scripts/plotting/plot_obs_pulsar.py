...
if __name__ == "__main__":
    ...
    add_group.add_argument('--pulsar_discovered', action='store_true',
                           help='Plots all pulsars discovered with the MWA (black star).')
    add_group.add_argument('--pulsar_rediscovered', action='store_true',
                           help='Plots all pulsars rediscovered with the MWA (grey star).')
    add_group.add_argument('--pulsar_unpublished', action='store_true',
                           help='Plots all pulsars unpublished discoveries with the MWA (black unfilled star).')
    ...
    SMART_metadata = [[0,  "B01", 1221399680, 330.4, -55.0, 485.2025886731764],
                      ...
                      [44,  "P13", 1367342464, 249.8, -72.0, 265.02151156889687],
                      [45,  "O03", 1368550080, 255.4, -40.5, 213.03080878759312],
                      [46,  "O01", 1367946928, 255.4, -13.0, 248.37431355295476],
                      [47,  "O02", 1368033096, 255.5, 18.3, 353.42164847654067],
                      [48,  "P12", 1367512184, 239.0, 1.6, 248.3332046976002],
                      [49,  "P11", 1366736704, 239.0, -26.7, 201.61303622511758],
                      [50,  "P07", 1302106648, 209.8, -55.0, 237.72379751220038],
                      [51,  "O08", 1369936552, 288.2, -40.5, 322.0344774986738],
                      [52,  "O06", 1369505736, 288.2, -13.0, 331.07145047411336],
                      [53,  "O07", 1369764224, 288.3, 18.3, 315.7291354581284],
                      [54,  "O05", 1369415648, 271.8, 1.6, 367.1944697208984],
                      [55,  "O04", 1368640168, 271.8, -26.7, 253.9714034120429],
                      [56,  "P14", 1367428632, 249.9, -55.0, 225.88809681630931],
