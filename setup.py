...
def get_git_version():
    git_version = (
        check_output("git describe --tags --long --dirty --always".split())
        .decode("utf-8")
        .strip()
    )
...
setup(
    ...
    url="https://github.com/CIRA-Pulsars-and-Transients-Group/mwa_search",
    # long_description=read('README.md'),
    python_requires=">=3.6",
    packages=["dpp", "mwa_search", "smart_database"],
    package_dir={
        "dpp": "lib/dpp",
        "mwa_search": "lib/mwa_search",
        "smart_database": "lib/smart_database",
    },
    ...
    scripts=[
        ...
        "scripts/mwa_search/grid.py",
        "scripts/mwa_search/lfDDplan.py",
        "scripts/mwa_search/LOTAAS_wrapper.py",
        "scripts/mwa_search/search_launch_loop.sh",
        "scripts/mwa_search/rsync_rm_loop.sh",
        "scripts/mwa_search/bestgridpos.py",
        "scripts/mwa_search/find_clustered_and_known_pulsar_candidates.py",
        # dpp
